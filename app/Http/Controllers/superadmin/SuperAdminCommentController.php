...
class SuperAdminCommentController extends Controller
{
    ...
    public function addComment(Request $request, $communityforumId){
        ...
        return redirect()->route('superadmin.communityforum')->with('success', 'Comment added successfully.');
    }
    ...
    public function updateComment(Request $request, $id){
        ...
        return redirect()->route('superadmin.communityforum')->with('success', 'Comment updated successfully.');
    }
    ...
    public function deleteComment($id){
        ...
        return redirect()->route('superadmin.communityforum')->with('success', 'Comment deleted successfully.');
    }
}
