...
class SuperAdminCommunityForumController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('superadmin.communityforum.communityforum', compact('communityforums'));
    }

    public function createCommunityforum(){

        return view('superadmin.communityforum.create');
    }
    ...
    public function editCommunityforum($id){
        ...
        return redirect()->route('superadmin.communityforum');
    }
    ...
    public function updateCommunityforum(Request $request, $id)
    {
        ...
        return redirect()->route('superadmin.communityforum')->with('success', 'Topic updated successfully!');
    }
    ...
    public function showComment($communityforumId){
        ...
        return view('superadmin.communityforum.showComment', compact('communityforums', 'comments'));
    }
    ...
    public function comment(){
        ...
        return view('superadmin.communityforum', compact('communityforums'));
    }
}
