            ...
            <div class="p-6 text-right z-10">
                ...
                @else
                    <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                        ...
                        <a href="{{ route('dentalclinics.create') }}" class="ml-1 font-semibold text-white hover:text-gray-300 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 bg-blue-600 p-1 px-2 rounded-lg hover:bg-blue-700">Create Clinic</a>
                    </div>
                @endif
            </div>
