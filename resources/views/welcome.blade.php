...
<body class="min-h-screen">
            ...
            <div class="grid grid-cols-1 gap-6 p-6">
                <div class="text-center">
                    ...
                    <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4" data-aos="fade-up" data-aos-duration="1000">
                        Dela Cirna Dental Clinic
                    </h1>
                    <!-- Subheading -->
                    <p class="text-base" data-aos="fade-up" data-aos-duration="1000">
                        "Every smile tells a story, and we’re here to help yours shine brighter with our expert dental care."
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="p-6 py-12">
        <a href="/" class="flex justify-center items-center py-6" data-aos="fade-up" data-aos-duration="1000">
            <img src="{{ asset('images/logo.png') }}" alt="Logo" class="w-12 h-12">
            <h3 class="text-xl lg:text-3xl font-bold ml-2">Dela Cirna Dental Clinic</h3>
        </a>
        ...
        <div class="flex justify-center items-center" data-aos="fade-up" data-aos-duration="1000">
            <div class="grid grid-cols-1 md:grid-cols-3 py-12 gap-6">
                ...
                <!-- Opening Hours -->
                <div class="px-6">
                    <h1 class="text-lg lg:text-xl mb-2">Opening Hours</h1>
                    <div class="flex items-center">
                        <span class="text-gray-500">
                ...
                <!-- Contacts -->
                <div class="px-6">
                    <h1 class="text-lg lg:text-xl mb-2">Contacts</h1>
                    
                    <span class="text-gray-500">
                        <i class="fa-solid fa-phone"></i>
                    </span>
                    <span class="text-gray-500 ml-2"><a class="hover:underline" href="tel:+639486593662">+63 948 6593 662</a></p>

                    <span class="text-gray-500">
                        <i class="fa-solid fa-envelope"></i>
                    </span>
                    <span class="text-gray-500 ml-2"><a class="hover:underline" href="mailto:admin@bataandental.com">admin@bataandental.com</a></span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="relative py-6">
        ...
        <div class="px-6 relative z-10">
            ...
            <!-- Content Grid -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-0 lg:px-8">
                <!-- Image Section -->
                ...
                <div class="flex flex-col justify-center">
                    <!-- Heading -->
                    <h2 class="text-xl lg:text-3xl font-semibold pb-4" data-aos="fade-up" data-aos-duration="1000">About Us</h2>
    ...
    <footer class="bg-gray-800 text-white pb-4">
        <div class="text-center">
            <h3 class="text-xl lg:text-2xl py-6">Developers</h3>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-4 px-8">
            
            <!-- Carl -->
            <div class="space-y-2">
                <h3 class="text-base lg:text-base">Carl Angelo Maniangap</h3>
                <p class="text-gray-300">
                    <i class="fas fa-envelope mr-2"></i>
                    <a class="hover:underline" href="mailto:carlangelomaniangap@gmail.com">carlangelomaniangap@gmail.com</a>
                </p>
                <p class="text-gray-300">
            ...
            <!-- Aldrin -->
            <div class="space-y-2 pt-6 sm:pt-0">
            ...
            <!-- Lexter -->
            <div class="space-y-2 pt-6 sm:pt-0">
                <h3 class="text-base lg:text-base">Lexter Dave Dumas</h3>
                <p class="text-gray-300">
                    <i class="fas fa-envelope mr-2"></i>
                    <a class="hover:underline" href="mailto:lexterdavedumas@example.com">lexterdavedumas@example.com</a>
                </p>
                <p class="text-gray-300">
                    <i class="fab fa-facebook-square mr-2"></i>
            ...
            <!-- Chris -->
            <div class="space-y-2 pt-6 sm:pt-0">
                <h3 class="text-base lg:text-base">Chris Pangilinan</h3>
                <p class="text-gray-300">
                    <i class="fas fa-envelope mr-2"></i>
                    <a class="hover:underline" href="mailto:chrispangilinan@example.com">chrispangilinan@example.com</a>
                </p>
                <p class="text-gray-300">
                    <i class="fab fa-facebook-square mr-2"></i>
                    <a href="https://facebook.com/" class="hover:text-gray-400">Facebook</a>
